---
layout: post
title: Android设计模式源码解析之外观模式(Facade)
categories: DesignPattern
description: Android设计模式源码解析之外观模式(Facade)
keywords: 设计模式
---
...
## 2. UML类图
 ![url](/images/posts/designpattern/facade.png)
...
## 不使用外观模式
 ![url](/images/posts/designpattern/no-facade.png)     
...
![context](/images/posts/designpattern/contextimpl.png)
